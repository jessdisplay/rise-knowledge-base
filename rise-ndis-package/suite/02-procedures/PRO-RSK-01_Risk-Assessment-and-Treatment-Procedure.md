...
**Procedure · PRO-RSK-01 · DRAFT v0.1**
...
| Field | Entry |
|---|---|
| Document ID / Type | PRO-RSK-01 · Procedure |
...
| PUTS INTO PRACTICE | Puts this into day-to-day practice | POL-RSK-01 Risk Management Policy |
| CARRIED OUT USING | Carried out using | FRM-RSK-01 Risk Assessment Form |
| REFERENCES | Other law this document must follow | PRPS NDIS (Provider Registration and Practice Standards) Rules 2018 |

## Purpose

This procedure sets out how, who and when for risk assessment and treatment.
...
| 2 | Responsible role | Carry out the task as this procedure's parent policy commits, recording on FRM-RSK-01 | FRM-RSK-01 |
| 3 | Responsible role | Log the completed record in REG-RSK-01 | REG-RSK-01 |
